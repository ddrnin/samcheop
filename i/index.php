...
<head>
    ...
    #home .slider .swiper-slide .box .box_wrap .boxtitle .button a {
        color: white;
        font-size: 20px;
        font-weight: bold;
        line-height: 55px;
    ...
    main .section.page1 .page1_wrap .name a {
        position: absolute;
        top: 15px;
        right: 0;
        font-size: 15px;
    ...
    main .section.page2 .page2_wrap .grid li:first-child a {
        font-size: 15px;
        font-weight: 500;
        color: #f0a500;
        border: none;
    ...
    @media only screen and (min-width: 100px) and (max-width: 1280px) {
        ...
        main .section.page3 .page3_wrap .title .box .b2 div {
            width: 100%;
            left: 60%;
        }
    }
    ...
    @media only screen and (min-width: 100px) and (max-width: 395px) {
        ...
        main .section.page3 .page3_wrap .title .box .b1 div {
            left: 43%;
        }
                    ...
                    <div class="box">
                        <div class="box_wrap" data-aos="fade-up" data-aos-anchor-placement="center-bottom"
                            ...
                            <div class="boxtitle">
                                ...
                                <div class="button"><a href="../menu/menu2_1.php">MORE+</a></div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="section page1">
            <div class="page1_wrap">
                <div class="name" data-aos="fade-left" data-aos-anchor-placement="center-bottom">
                    새소식<a href="../news/news1.php">MORE+</a>
                </div>
                <div class="swiper slider2" data-aos="fade-right" data-aos-anchor-placement="center-bottom">
                    <ul class="swiper-wrapper slider">
                        <li class="swiper-slide">
                            <a href="../news/news1_1.php"><img src="./img/sec1_img1.png" alt="" /></a>
                        </li>
                        <li class="swiper-slide">
                            <a href="../news/news1_1.php"><img src="./img/sec1_img2.png" alt="" /></a>
                        </li>
                        <li class="swiper-slide">
                            <a href="../news/news1_1.php"><img src="./img/sec1_img3.png" alt="" /></a>
                        </li>
                        <li class="swiper-slide">
                            <a href="../news/news1_1.php"><img src="./img/sec1_img4.jpg" alt="" /></a>
                        </li>
                        <li class="swiper-slide">
                            <a href="../news/news1_1.php"><img src="./img/sec1_img5.jpg" alt="" /></a>
                        </li>
                        <li class="swiper-slide">
                            <a href="../news/news1_1.php"><img src="./img/sec1_img6.jpg" alt="" /></a>
                        </li>
                        <li class="swiper-slide">
                            <a href="../news/news1_1.php"><img src="./img/sec1_img7.png" alt="" /></a>
                        </li>
                        <li class="swiper-slide">
                            <a href="../news/news1_1.php"><img src="./img/sec1_img8.png" alt="" /></a>
                        </li>
                        <li class="swiper-slide">
                            <a href="../news/news1_1.php"><img src="./img/sec1_img9.png" alt="" /></a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="section page2">
            <div class="page2_wrap" data-aos="fade-left" data-aos-anchor-placement="center-bottom">
                <ul class="grid">
                    <li>
                        <div class="title">
                            인스타그램<br /><span>@samcheop__official</span><br /><a
                                href="https://www.instagram.com/p/Cx7MkPULAfM/?hl=ko" target="_blank">MORE+</a>
                        </div>
                    </li>
                    <li>
                        <a href="https://www.instagram.com/p/Cx7MkPULAfM/?hl=ko" target="_blank"><img
                                src="./img/sec2_img2.png" alt="" /></a>
                    </li>
                    <li>
                        <a href="https://www.instagram.com/p/Cx7MkPULAfM/?hl=ko" target="_blank"><img
                                src="./img/sec2_img3.png" alt="" /></a>
                    </li>
                    <li>
                        <a href="https://www.instagram.com/p/Cx7MkPULAfM/?hl=ko" target="_blank"><img
                                src="./img/sec2_img4.png" alt="" /></a>
                    </li>
                    <li>
                        <a href="https://www.instagram.com/p/Cx7MkPULAfM/?hl=ko" target="_blank"><img
                                src="./img/sec2_img5.png" alt="" /></a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="page3_wrap">
                <div class="title">
                    ...
                    <div class="box" data-aos="fade-left" data-aos-anchor-placement="center-bottom"
                        data-aos-delay="300">
                        <div class="boxtitle">
                            <a href="../about/about5.php" class="bs b1">
                                <div>창업문의</div>
                            </a>
                            <img src="./img/sec3_img.png" alt="" />
                            <a href="../about/about1.php" class="bs b2">
                                <div>왜 삼첩분식인가</div>
                            </a>
                        </div>
                        <a href="https://samcheop.wmpoplus.com/location/setting" target="_blank" class="bs b3">
                            <div>공식 앱 다운</div>
                        </a>
                    </div>
                </div>
